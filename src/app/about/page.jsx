        ...
        <section className="text-white" id="about">
          <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
            ...
            <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
              <h2 className="text-4xl font-bold text-white mb-4">About Me</h2>
              <p className="text-base lg:text-lg">
                My frontend development service showcases an exquisite blend of creativity and functionality. With an adept mastery of HTML, CSS, Next.js, React.js, Tailwind CSS, and JavaScript, I craft captivating user experiences that seamlessly fuse aesthetics with user-centric design. My attention to detail and commitment to innovation elevate digital landscapes, making every project a masterpiece.
              </p>
              <div className="flex flex-row justify-start mt-8">
